                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('backsite.doctors.store') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row {{ $errors->has('specialists_id') ? 'has-error' : '' }}">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            ...
                                                            @if($errors->has('specialists_id'))
                                                                <p style="font-style: bold; color: red;">{{ $errors->first('specialists_id') }}</p>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <tbody>
                                                        @forelse($doctors as $key => $doctor_item)
                                                            <tr data-entry-id="{{ $doctor_item->id }}">
                                                                ...
                                                                <td>{{ $doctor_item->specialists->name ?? '' }}</td>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <div class="btn-group mr-1 mb-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            @can('doctor_show')
                                                                                <a href="#mymodal"
                                                                                    data-remote="{{ route('backsite.doctors.show', $doctor_item->id) }}"
                                                                                    data-toggle="modal"
                                                                                    data-target="#mymodal"
                                                                            ...
                                                                            @can('doctor_edit')
                                                                                <a class="dropdown-item" href="{{ route('backsite.doctors.edit', $doctor_item->id) }}">
                                                                                    Edit
                                                                                </a>
                                                                            @endcan

                                                                            @can('doctor_delete')
                                                                                <form action="{{ route('backsite.doctors.destroy', $doctor_item->id) }}" method="POST" onsubmit="return confirm('Are you sure want to delete this data ?');">
