                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('backsite.specialists.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body card-dashboard">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered text-inputs-searching default-table">
                                                    ...
                                                    <tbody>
                                                        @forelse($specialists as $key => $specialist_item)
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <div class="btn-group mr-1 mb-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            @can('specialist_show')
                                                                                <a href="#mymodal"
                                                                                    data-remote="{{ route('backsite.specialists.show', $specialist_item->id) }}"
                                                                                    data-toggle="modal"
                                                                                    data-target="#mymodal"
                                                                            ...
                                                                            @can('specialist_edit')
                                                                                <a class="dropdown-item" href="{{ route('backsite.specialists.edit', $specialist_item->id) }}">
                                                                                    Edit
                                                                                </a>
                                                                            @endcan

                                                                            @can('specialist_delete')
                                                                                <form action="{{ route('backsite.specialists.destroy', $specialist_item->id) }}" method="POST" onsubmit="return confirm('Are you sure want to delete this data ?');">
