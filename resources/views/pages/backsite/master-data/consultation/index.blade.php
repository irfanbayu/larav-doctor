                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('backsite.consultations.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body card-dashboard">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered zero-configuration">
                                                    ...
                                                    <tbody>
                                                        @forelse($consultations as $key => $consultation_item)
                                                                    ...
                                                                    <div class="btn-group mr-1 mb-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            @can('consultation_show')
                                                                                <a href="#mymodal"
                                                                                    data-remote="{{ route('backsite.consultations.show', $consultation_item->id) }}"
                                                                                    data-toggle="modal"
                                                                                    data-target="#mymodal"
                                                                            ...
                                                                            @can('consultation_edit')
                                                                                <a class="dropdown-item" href="{{ route('backsite.consultations.edit', $consultation_item->id) }}">
                                                                                    Edit
                                                                                </a>
                                                                            @endcan

                                                                            @can('consultation_delete')
                                                                                <form action="{{ route('backsite.consultations.destroy', $consultation_item->id) }}" method="POST" onsubmit="return confirm('Are you sure want to delete this data ?');">
