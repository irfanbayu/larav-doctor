            ...
            <div class="lg:col-span-7 lg:pl-8 lg:pr-20">
                ...
                <div class="flex flex-wrap items-center space-x-5">
                    <div class="flex-shrink-0">
                        <img src="{{ url(Storage::url($appointment->doctors->photo)) }}" class="w-20 h-20 rounded-full bg-center object-cover object-top" alt="Doctor 1"/>
                    </div>
                    ...
                    <div class="flex-1 space-y-1">
                        ...
                        <div class="text-[#AFAEC3]">{{ $appointment->doctors->specialists->name ?? '' }}</div>
                ...
                <div class="mt-16">
                    ...
                    <div class="flex items-center justify-between mt-5">
                        ...
                        <div class="text-[#1E2B4F] font-medium">{{ $appointment->consultations->name ?? '' }}</div>
                    </div>
                ...
                <div class="mt-16">
                    ...
                    <div class="flex items-center justify-between mt-5">
                        ...
                        <div class="text-[#1E2B4F] font-medium">{{ 'IDR '.number_format($appointment->doctors->specialists->price) ?? '' }}</div>
                    </div>

                    <div class="flex items-center justify-between mt-5">
                        <div class="text-[#AFAEC3] font-medium">Fee dokter</div>
                        <div class="text-[#1E2B4F] font-medium">{{ 'IDR '.number_format($appointment->doctors->fee) ?? '' }}</div>
                    </div>
            ...
            <div class="lg:col-span-5 lg:pl-20 lg:pr-7 mt-10 lg:mt-0">
                ...
                <form action="{{ route('payment.store') }}" method="POST" enctype="multipart/form-data" x-data="{ payment: '' }" class="mt-8">
                    ...
                    <div class="mt-10 grid">
                        ...
                        <input type="hidden" name="appointments_id" value="{{ $id ?? '' }}">
